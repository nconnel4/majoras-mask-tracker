...
export const Items = React.memo(({ inventory }: SectionProps) => {
  return (
    <div className="items">
      <Item id="ocarina" active={inventory.ocarina} />
      {!inventory.heroBow2 && <Item id="heroBow" active={inventory.heroBow} />}
      {inventory.heroBow2 && !inventory.heroBow3 && (
        <Item id="heroBow2" active={inventory.heroBow2} />
      )}
      {inventory.heroBow3 && <Item id="heroBow3" active={inventory.heroBow3} />}
      ...
      {inventory.wallet2 && <Item id={"wallet2"} active={inventory.wallet2} />}
